  ...
  return (
    <div className="overflow-hidden px-4 min-h-screen w-screen bg-white flex flex-col justify-center items-center gap-y-3">
      ...
      <div className="z-10 relative px-3 md:px-0">
        ...
        />
        <div className="-z-50 absolute top-0 left-0 size-96 bg-zinc-300 rounded-full filter blur-3xl opacity-9"></div>
        <div className="-z-50 absolute bottom-0 left-0 size-96 bg-slate-300 rounded-full filter blur-3xl opacity-9"></div>

        <div className="-z-50 absolute top-0 right-0 size-96 bg-slate-300 rounded-full filter blur-3xl opacity-9"></div>
        <div className="-z-50 absolute bottom-0 right-0 size-96 bg-zinc-300 rounded-full filter blur-3xl opacity-9"></div>
      </div>
